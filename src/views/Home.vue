...
export default {
  data() {
    return {
      // 左侧菜单
      menuList: [
        {id: 0, title: "课程", path: "/", slist: [
          {id: 0, title: "开始选课", path: "/course"},
          {id: 1, title: "选课记录", path: "/order"},
          ]},
        {id: 1, title: "管理", path: "/", slist: [
          {id: 0, title: "管理课程", path: "/manage_course"},
          {id: 1, title: "管理用户", path: "/manage_user"},
          ]}
      ],
      iconsObject: {
